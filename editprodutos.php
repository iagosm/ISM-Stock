...
<body>
    <div class="form-container-cadastrar">
        <form action="config/produto.php" method="POST">
            ...
            <input type="hidden" name="sku" value="<?= $produtos["sku"] ?>">
            <p>Preencha os campos abaixo</p>
            <div class="form-group-select div-cadastro">
                <label for="nome">Nome</label>
                <input type="text" name="nome" placeholder="Digite o nome do produto" value="<?= $produtos["nome"]?>" required>
            </div>
            <div class="form-group-select div-cadastro">
                <label for="sku">SKU</label>
                <input type="text" name="sku" placeholder="Digite o SKU do produto" value="<?= $produtos["sku"]?>" required disabled>
            </div>

            <div class="form-group-select div-cadastro">
                <label for="quantidade">Quantidade</label>
                <input type="text" name="quantidade" placeholder="Digite a quantidade" value="<?= $produtos["quantidade"]?>" required>
            </div>
